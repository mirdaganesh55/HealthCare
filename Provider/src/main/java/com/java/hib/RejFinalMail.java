...
public class RejFinalMail {

	Provider provider = new Provider();
	String from = "professional.ganesh237@gmail.com";
	String imagePath = "C:\\Users\\ganeshmi\\Downloads\\providerImage.jpg";
	String body = "<html>" +
			"<head>"+
			"<style>" +
			"body {" +
			...
			"<p>Welcome...</p>" +
			"<p>"+
			"We regret to inform you that the activation process for your provider details has been rejected." +
			"After careful review, it has been determined that certain information did not meet our requirements or standards. That applied on " +
			"<span style='color: #FAFA14;'>" + provider.getEnrollmentDate() + "</span> date." +
			"</p>" +
			"<p>Reason for Rejection : Your Qualification does not matches our Criteria." +provider.getQualification()+ "</p>"+
	...
	public static String mailRej(String toEmail,String subject,String content,String from, String imagePath,String body) {
		...
		try {
			...
			mimeMessage.addRecipient(Message.RecipientType.TO, new InternetAddress(provider.getEmail()));
