...
public class QualiMail {
	...
	public void sendEmail(Provider provider) {
		...
		String body = "<html>" +
				...
				"<p>Welcome...</p>" +
				"<p>"+
				"We regret to inform you that the activation process for your provider details has been rejected.Your Qualification does not matches" +
