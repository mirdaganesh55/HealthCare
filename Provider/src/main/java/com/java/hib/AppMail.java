...
public class AppMail {
	...
	public static void sendEmail(Provider provider) {
		...
		String imagePath = "C:\\Users\\ganeshmi\\Downloads\\camilo-jimenez-vGu08RYjO-s-unsplash.jpg"; // Replace with the actual path to your image file
		...
		String body = "<html>" +
				...
				"<h1>Dear <span style='color: #3196CF;'>" + provider.getFirstName() + " " + provider.getLastName() + "</span></h1>" +
				"<p>Welcome...</p>" +
				"<p>"+
				...
				"<span style='color: #3196CF;'>" + provider.getEnrollmentDate() + "</span> date." +
				"</p>" +
				"<p>Your Provider ID is <span style='color: #3196CF;'>" + provider.getProviderId() + "</span></p>"+
