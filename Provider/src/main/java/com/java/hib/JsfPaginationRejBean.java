...
public class JsfPaginationRejBean {
	...
	public List<Provider> getProviderByRejList() {
		if (cdList == null) {
			loadProvider();
		}
		return cdList;
	...
	private void loadProvider() {
		...
		cdList = queryHelper.getRejProviderList(firstRow, rowsPerPage);
		System.out.println("Employ Count is  " +cdList);
		totalRows = queryHelper.countRows2();
