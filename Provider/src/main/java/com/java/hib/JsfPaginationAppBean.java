...
public class JsfPaginationAppBean {
	...
	public List<Provider> getProviderByAppList() throws ParseException {
		if (cdList == null) {
			loadProvider();
		}
		return cdList;
	...
	private void loadProvider() throws ParseException {
		...
		cdList = queryHelper.getAppProviderList(firstRow, rowsPerPage);
		System.out.println("Employ Count is  " +cdList);
		totalRows = queryHelper.countRows3();
